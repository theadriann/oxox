...
import { createPluginCapabilityState$, type PluginCapabilityState } from './plugin-capability.state'
...
export class PluginCapabilityStore {
  ...
  readonly state$: Observable<PluginCapabilityState> = createPluginCapabilityState$()
