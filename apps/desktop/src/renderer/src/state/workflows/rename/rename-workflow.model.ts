...
import { createRenameWorkflowState$, type RenameWorkflowState } from './rename-workflow.state'
...
export class RenameWorkflowStore {
  readonly state$: Observable<RenameWorkflowState> = createRenameWorkflowState$()
