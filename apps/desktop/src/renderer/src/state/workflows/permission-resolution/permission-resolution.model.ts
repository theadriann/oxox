...
import {
  createPermissionResolutionState$,
  type PermissionResolutionState,
} from './permission-resolution.state'
...
export class PermissionResolutionStore {
  readonly state$: Observable<PermissionResolutionState> = createPermissionResolutionState$()
